...
.org-editpd-content > span {
  @apply font-black text-[35px] text-left w-full px-[5px];
} /* lock */

.org-editpd-table-frame {
  @apply flex flex-col items-start justify-start gap-3 w-full grow;
}
.org-editpd-table-frame > div {
  @apply flex flex-row w-full gap-3;
}
.org-editpd-table-frame input,
.org-editpd-table-frame > textarea {
  @apply border-[1px] border-[#aaa] text-[13px] p-[10px] w-full;
}
.org-editpd-table-frame > textarea {
  @apply grow resize-none;
}
.org-editpd-table-frame button {
  @apply border-[1px] border-[#F18642] bg-[#F18642] text-white text-[13px] p-[10px] w-[170px];
}
.org-editpd-table-frame button:hover {
...
<template>
  <div class="org-editpd-body">
    <OrgNavBarComponent />
    <div class="org-editpd-content">
      <span>Create Pre-Defined Workflow</span>

      <form
        class="org-editpd-table-frame"
      ...
      >
        ...
        <div>
          <input
            ...
            required
          />
          <button class="rounded-[5px]" type="submit">Create Workflow</button>
        </div>
      </form>
    </div>
  </div>
