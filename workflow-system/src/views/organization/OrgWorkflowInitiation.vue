        ...
        if (currentUser != null) {
          ...
          Promise.all(userFile.map((file) => file.save())).then(
            (savedFiles) => {
              ...
              const customTemplate = Parse.Object.extend(
                "Org_Workflow_Template"
              );
