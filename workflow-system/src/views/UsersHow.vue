      ...
      <div id="dashboard" class="dashboard">
        ...
        <div class="dashboard-list">
          <table class="font-['Inter'] text-[13px]">
            <tbody>
              <tr>
                <td class="text-left bg-white w-[125px] font-bold">Process Name</td>
                <td class="text-left bg-white">
                  the name of the Organizational Process the workflow was created for
                </td>
              </tr>
              <tr>
                <td class="text-left bg-white w-[125px] font-bold">File Attachment</td>
                <td class="text-left bg-white">
              ...
              <tr>
                ...
                <td class="text-left bg-white">
                  the progress of the workflow. Users can further see the progress for each workflow by clicking on the
                  progress.
                </td>
              </tr>
              <tr>
                ...
                <td class="text-left bg-white">
                  the status of the workflow; Pending, Completed, Rejected. Pending means the workflow is not yet
                  finished. Completed means the workflow has been completed or approved. Rejected means the workflow has
                  been rejected or disapproved.
                </td>
              </tr>
              <tr>
                <td class="text-left bg-white w-[125px] font-bold">Action</td>
                <td class="text-left bg-white">
                  displays button where users can cancel ongoing workflows and if finished can download or view the file
                  attachment that has been stamped.
                </td>
              </tr>
            </tbody>
          </table>
